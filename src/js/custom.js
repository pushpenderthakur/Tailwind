...
$('.slider').slick({
    ...
    tabNews.addEventListener("click", () => {
      contentNews.classList.remove("hidden");
      contentOther.classList.add("hidden");
      tabNews.classList.add("bg-blue-700", "text-white");
      tabOther.classList.remove("bg-blue-700", "text-white");
      tabOther.classList.add("text-gray-700");
    });
  
    tabOther.addEventListener("click", () => {
      contentOther.classList.remove("hidden");
      contentNews.classList.add("hidden");
      tabOther.classList.add("bg-blue-700", "text-white");
      tabNews.classList.remove("bg-blue-700", "text-white");
      tabNews.classList.add("text-gray-700");
    });
